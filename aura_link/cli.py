...
@main.command()
@click.option("--url", envvar="AURA_SERVER", default=None, help="Backend server URL (default: http://localhost:8000)")
@click.option("--web", "web_url", default=None, help="Web UI URL (default: http://localhost:5173)")
